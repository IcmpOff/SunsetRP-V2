...
local function saveVehicle()
	...
	local myCar = exports['srp-base']:FetchVehProps(veh)
...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("srp-bennys:attemptPurchase", Player.id, Player.cash, type, upgradeLevel)
...
AddEventHandler("srp-bennys:purchaseSuccessful", function(cash)
    local LocalPlayer = exports["srp-base"]:getModule("LocalPlayer")
    local Player = LocalPlayer:getCurrentCharacter()
