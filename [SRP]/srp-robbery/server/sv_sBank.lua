...
RegisterNetEvent('srp-robbery:smallBankAttempt')
AddEventHandler('srp-robbery:smallBankAttempt', function(bId)
    ...
    TriggerClientEvent('srp-robbery:updateBankData', -1, banks)
    print('Robbing Bank; ' .. tostring(bId))
end)

RegisterNetEvent('srp-robbery:sBankBox')
AddEventHandler('srp-robbery:sBankBox', function(bId, iType)

    banks[bId]['rob'][iType] = true
    TriggerClientEvent('srp-robbery:updateBankData', -1, banks)
    TriggerClientEvent('srp-robbery:sBankLoot', source)
