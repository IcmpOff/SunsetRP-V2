...
RegisterNetEvent('srp-robbery:attemptRegisterRobbery')
AddEventHandler('srp-robbery:attemptRegisterRobbery', function(sId, rId)
    ...
    TriggerClientEvent('srp-robbery:regSuccess', source)
end)

RegisterNetEvent('srp-robbery:attemptSafeRobbery')
AddEventHandler('srp-robbery:attemptSafeRobbery', function(sId)
    print('Debug!')
    ...
    TriggerClientEvent('srp-robbery:safeSuccess', source)
end)
