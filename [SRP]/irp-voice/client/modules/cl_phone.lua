...
function LoadPhoneModule()
    ...
    RegisterNetEvent("irp-voice:phone:call:start")
    AddEventHandler("irp-voice:phone:call:start", StartPhoneCall)

    RegisterNetEvent("irp-voice:phone:call:end")
    AddEventHandler("irp-voice:phone:call:end", StopPhoneCall)
    ...
    TriggerEvent("irp-voice:phone:ready")
