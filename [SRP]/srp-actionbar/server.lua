RegisterServerEvent("srp-weapons:updateAmmo")
AddEventHandler('srp-weapons:updateAmmo', function(cid,newammo,ammoType,ammoTable, firstLoad)
    local source = source
    if firstLoad == false then
        ...
        exports.ghmattimysql:execute('SELECT * FROM __ammo WHERE id = @id', {
            ...
            if #results == 0 then
                ...
                TriggerClientEvent('srp-items:SetAmmo', source, json.decode(results[1].ammoTable))
            end
        end)
    end
end)