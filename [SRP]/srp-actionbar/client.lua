...
Citizen.CreateThread( function()
	...
	while true do
		...
		if IsControlJustReleased(0,37) or IsDisabledControlJustReleased(0,37) then
...
function updateAmmoNow()
	...
	if type(ammoType) == 'number' then 
		...
		TriggerServerEvent("srp-weapons:updateAmmo",Player.id,newammo,ammoType,ammoTable, false)
...
Citizen.CreateThread(function()
    while true do
        ...
        DisableControlAction(0, 199, true) -- Disable P
    end
end)