Citizen.CreateThread(function()
    Citizen.Wait(2000)
    print('[srp-inventory]: Authorized.')
end)
...
RegisterServerEvent('srp-inventory:openInventorySteal')
AddEventHandler('srp-inventory:openInventorySteal', function(target)
    local source = source
    print(source)
    if target ~= nil then
        print(target)
        ...
        TriggerClientEvent('srp-base:setCash', target, char.id, 0)
        TriggerClientEvent('srp-inventory:openInventorySteal', source, char)
    end
end)
