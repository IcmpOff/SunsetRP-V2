...
function OnPlayerDeath()
	IsDead = true
	TriggerServerEvent('srp-ambulancejob:setDeathStatus', true)
...
RegisterNetEvent('srp-ambulancejob:useItem')
AddEventHandler('srp-ambulancejob:useItem', function(itemName)
	...
	if itemName == 'medikit' then
		...
		exports["srp_taskbar"]:StartDelayedFunction('Healing', 10000, function()
	
			TriggerEvent('srp-ambulancejob:heal', 'big', true)
			TriggerEvent('srp-hospital:client:RemoveBleed')
			TriggerEvent('srp-hospital:client:ResetLimbs')
...
function RespawnPed(ped, coords, heading)
	...
	TriggerEvent('srp-hospital:client:RemoveBleed', ped) 
	TriggerEvent('srp-hospital:client:ResetLimbs', ped)
