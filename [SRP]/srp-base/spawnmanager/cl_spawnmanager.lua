...
function SRP.SpawnManager.InitializeSwapChar(self)
    Citizen.CreateThread(function()
        FreezeEntityPosition(PlayerPedId(), true)
...
RegisterNetEvent('srp-base:SwapChar')
AddEventHandler('srp-base:SwapChar', function()
    SRP.SpawnManager:InitializeSwapChar()
end)
...
function SRP.SpawnManager.InitialSpawn(self)
    Citizen.CreateThread(function()
        ...
        local spawn = SRP.Enums.SpawnLocations.Initial[1]
        ...
        --if new then TriggerEvent("srp-base:newCharacterSpawned") end
