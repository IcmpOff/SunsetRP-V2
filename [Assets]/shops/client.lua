...
Citizen.CreateThread(function()
	...
	while true do
		...
		if(Vdist( 977.81, -101.04, 74.85, pos.x, pos.y, pos.z) < 20.0)then
			found = true
		...
		if(Vdist( 1108.45, -2007.2, 30.95, pos.x, pos.y, pos.z) < 20.0)then
			...
			if(Vdist( 1108.45, -2007.2, 30.95, pos.x, pos.y, pos.z) < 2.0)then
				...
				if IsControlJustPressed(1, 38) then	
					exports["srp-taskbar"]:taskBar(60000,"Readying Smelter")
		...
		if(Vdist(467.5569, -992.8262, 24.92082, pos.x, pos.y, pos.z) < 20.0)then
			found = true
