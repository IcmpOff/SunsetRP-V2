...
local carspawns = {
	...
	[8] =  { ['x'] = -9.97,['y'] = -1082.634,['z'] = 26.43,['h'] = 69.5, ['info'] = ' Car Spot 8' },
	[9] =  { ['x'] = -17.13,['y'] = -1103.1,['z'] = 26.43,['h'] = 336.46, ['info'] = ' Car Spot 9' },
}

local carTable = {
	[1] = { ["name"] = "Gauntlet", ["model"] = "gauntlet", ["baseprice"] = 100000, ["commission"] = 15 }, 
	[2] = { ["name"] = "Dubsta 3", ["model"] = "dubsta3", ["baseprice"] = 100000, ["commission"] = 15 },
	[3] = { ["name"] = "Landstalker", ["model"] = "landstalker", ["baseprice"] = 100000, ["commission"] = 15 },
	[4] = { ["name"] = "Bobcat XL", ["model"] = "bobcatxl", ["baseprice"] = 100000, ["commission"] = 15 },
	[5] = { ["name"] = "Surfer", ["model"] = "surfer", ["baseprice"] = 100000, ["commission"] = 15 },
	[6] = { ["name"] = "Glendale", ["model"] = "glendale", ["baseprice"] = 100000, ["commission"] = 15 },
	[7] = { ["name"] = "Washington", ["model"] = "washington", ["baseprice"] = 100000, ["commission"] = 15 },
	[8] = { ["name"] = "Food Truck New", ["model"] = "taco", ["baseprice"] = 4000, ["commission"] = 0},
	[9] = { ["name"] = "Towtruck", ["model"] = "flatbed", ["baseprice"] = 4000, ["commission"] = 0},
}
	...
	Citizen.CreateThread(function()
		if not endingCreator then
			...
			if not boughtcar then
				...
				exports["srp-carhud"]:SetFuel(personalvehicle, 100)
				local vehProps = exports['srp-base']:FetchVehProps(personalvehicle)
...
AddEventHandler('event:control:towgarage', function(useID)
	local rankCarshop = exports["isPed"]:GroupRank("PDM")
...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(500)
        if insideVehShop then
			rank = exports["isPed"]:GroupRank("PDM")
            Citizen.Wait(10000)
        end
    end
end)